...
void* func0() {
	...
	if(cyield() == 0)
		printf("cyield realizado com sucesso pela thread 1\n");
	else
		printf("Erro no cyield da thread 1\n");
}

void* func1() {
	printf("Eu sou a thread ID2 \n");
	if(cyield() == 0)
		printf("cyield realizado com sucesso pela thread 2\n");
	else
		printf("Erro no cyield da thread 2\n");
